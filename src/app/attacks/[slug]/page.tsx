    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mt-12 p-8 rounded-lg border border-green-500/30 bg-green-500/5 text-center">
          ...
          <p className="text-neutral-400 mb-4"><Link href="/" className="text-green-400 hover:text-green-300 underline">PwnClaw&apos;s AI agent security testing</Link> includes {cat.count} {cat.title.toLowerCase()} in its 112-attack library. Get your score in 5 minutes.</p>
          <Link href="/sign-up">
