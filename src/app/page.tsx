      ...
      <section className="px-6 pt-16 pb-8 md:pt-24 md:pb-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-neutral-400 mb-8 max-w-2xl mx-auto">
            PwnClaw is an AI agent security testing platform. 112 real-world attacks — jailbreaks, prompt injection, data exfiltration, MCP poisoning, and more. Get a security score and copy-paste fix instructions for every vulnerability found. Results in five minutes. No API keys needed.
          </p>
