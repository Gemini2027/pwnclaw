    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="px-6 pt-16 pb-8 md:pt-24 md:pb-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-neutral-400 mb-8 max-w-2xl mx-auto">
            Think of it as <span className="text-white font-medium">antivirus for AI agents</span>. 112 real-world attacks — jailbreaks, prompt injection, data exfiltration, MCP poisoning, and more. Security score plus fix instructions for every vulnerability found. Results in five minutes, no API keys needed.
          </p>
      ...
      <section className="px-6 py-16 border-t border-neutral-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a href="https://github.com/ClawdeRaccoon/pwnclaw" target="_blank" rel="noopener" className="inline-flex items-center gap-2 mt-6 px-4 py-2 rounded-full border border-neutral-700 bg-neutral-900 text-neutral-400 text-xs hover:text-white hover:border-neutral-500 transition">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-stretch">
            ...
            <Card className="bg-neutral-900 border-neutral-800 flex flex-col">
              ...
              <CardContent className="flex flex-col flex-grow">
                <ul className="space-y-3 text-neutral-400 flex-grow">
                  ...
                  <li>✓ AI-powered analysis &amp; fix instructions</li>
                  <li>✓ Security score, grade &amp; benchmark</li>
            ...
            <Card className="bg-neutral-900 border-green-500 relative flex flex-col">
              ...
              <CardContent className="flex flex-col flex-grow">
                <ul className="space-y-3 text-neutral-400 flex-grow">
                  <li className="text-white font-semibold">✓ 30 scans per month</li>
            ...
            <Card className="bg-neutral-900 border-neutral-800 flex flex-col">
              ...
              <CardContent className="flex flex-col flex-grow">
                <ul className="space-y-3 text-neutral-400 flex-grow">
                  <li className="text-white font-semibold">✓ 150 scans per month</li>
